...
# Generated by manifest-generator.sh
...
list_templates() {
    ...
    echo -e "  ${GREEN}cp templates/configs/production.yaml stacks/mixins/profiles/production.yaml${NC}"
    echo -e "  ${GREEN}#   import: [..., mixins/profiles/production]${NC}"
    echo -e ""
