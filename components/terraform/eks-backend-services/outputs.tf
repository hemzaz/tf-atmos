...
output "namespace" {
  ...
  value       = kubernetes_namespace_v1.backend_services.metadata[0].name
}

output "service_endpoints" {
  description = "Service endpoints for backend services"
  value = {
    for service_name, service in kubernetes_service_v1.backend_services : service_name => {
...
output "service_accounts" {
  ...
  value = {
    for service_name, sa in kubernetes_service_account_v1.backend_services : service_name => {
...
output "config_maps" {
  ...
  value = {
    for service_name, cm in kubernetes_config_map_v1.backend_services_config : service_name => {
...
output "network_policy" {
  ...
  value = {
    name      = kubernetes_network_policy_v1.backend_services_network_policy.metadata[0].name
    namespace = kubernetes_network_policy_v1.backend_services_network_policy.metadata[0].namespace
  }
}
