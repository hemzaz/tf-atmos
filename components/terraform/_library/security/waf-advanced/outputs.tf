...
output "cloudwatch_metrics" {
  ...
  value = {
    ...
    namespace           = "AWS/WAFV2"
    dashboard_url       = "https://console.aws.amazon.com/cloudwatch/home?region=${data.aws_region.current.region}#metricsV2:graph=~();query=~'*7bAWS*2fWAFV2*2cRegion*2cRule*2cWebACL*7d*20${local.web_acl_name}"
