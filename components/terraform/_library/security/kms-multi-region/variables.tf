...
variable "allow_eventbridge" {
  type        = bool
  description = "Let EventBridge (events.amazonaws.com) encrypt event buses and archives of this account and region with the key, scoped by aws:SourceAccount and aws:SourceArn"
  default     = false
}
